...
export interface Instruction {
    ...
    instructionType: {
        ...
        oneofKind: "addSaliencyCandidate";
        /**
         * Pops a boolean from the stack, and adds a saliency candidate to the
         * current list.
         *
         * @generated from protobuf field: Yarn.Instruction.AddSaliencyCandidateInstruction addSaliencyCandidate = 21;
         */
        addSaliencyCandidate: Instruction_AddSaliencyCandidateInstruction;
    } | {
        oneofKind: "addSaliencyCandidateFromNode";
        /**
         * Add a saliency candidate to the current list, given a node name.
         *
         * @generated from protobuf field: Yarn.Instruction.AddSaliencyCandidateFromNodeInstruction addSaliencyCandidateFromNode = 22;
         */
        addSaliencyCandidateFromNode: Instruction_AddSaliencyCandidateFromNodeInstruction;
    } | {
        oneofKind: "selectSaliencyCandidate";
        /**
         ...
         * returning.
         *
         * @generated from protobuf field: Yarn.Instruction.SelectSaliencyCandidateInstruction selectSaliencyCandidate = 23;
         */
        selectSaliencyCandidate: Instruction_SelectSaliencyCandidateInstruction;
    } | {
        oneofKind: undefined;
    };
}
...
/**
 * @generated from protobuf message Yarn.Instruction.AddSaliencyCandidateInstruction
 */
export interface Instruction_AddSaliencyCandidateInstruction {
    /**
     * The unique ID for this piece of content, such as a line ID.
     *
     * @generated from protobuf field: string contentID = 1;
     */
    contentID: string;
    /**
     * The complexity score of the candidate.
     *
     * @generated from protobuf field: int32 complexityScore = 2;
     */
     ...
     *
     * @generated from protobuf field: int32 destination = 3;
     */
    destination: number;
}
/**
 * @generated from protobuf message Yarn.Instruction.AddSaliencyCandidateFromNodeInstruction
 */
export interface Instruction_AddSaliencyCandidateFromNodeInstruction {
    /**
...
/**
 * @generated from protobuf message Yarn.Instruction.SelectSaliencyCandidateInstruction
 */
export interface Instruction_SelectSaliencyCandidateInstruction {
}
/**
...
class Program$Type extends MessageType<Program> {
    ...
    internalBinaryWrite(message: Program, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of globalThis.Object.keys(message.initialValues)) {
...
class Instruction$Type extends MessageType<Instruction> {
    constructor() {
        super("Yarn.Instruction", [
            ...
            { no: 21, name: "addSaliencyCandidate", kind: "message", oneof: "instructionType", T: () => Instruction_AddSaliencyCandidateInstruction },
            { no: 22, name: "addSaliencyCandidateFromNode", kind: "message", oneof: "instructionType", T: () => Instruction_AddSaliencyCandidateFromNodeInstruction },
            { no: 23, name: "selectSaliencyCandidate", kind: "message", oneof: "instructionType", T: () => Instruction_SelectSaliencyCandidateInstruction }
        ]);
    }
    create(value?: PartialMessage<Instruction>): Instruction {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.instructionType = { oneofKind: undefined };
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* Yarn.Instruction.ReturnInstruction return */ 20:
                    ...
                    break;
                case /* Yarn.Instruction.AddSaliencyCandidateInstruction addSaliencyCandidate */ 21:
                    message.instructionType = {
                        oneofKind: "addSaliencyCandidate",
                        addSaliencyCandidate: Instruction_AddSaliencyCandidateInstruction.internalBinaryRead(reader, reader.uint32(), options, (message.instructionType as any).addSaliencyCandidate)
                    };
                    break;
                case /* Yarn.Instruction.AddSaliencyCandidateFromNodeInstruction addSaliencyCandidateFromNode */ 22:
                    message.instructionType = {
                        oneofKind: "addSaliencyCandidateFromNode",
                        addSaliencyCandidateFromNode: Instruction_AddSaliencyCandidateFromNodeInstruction.internalBinaryRead(reader, reader.uint32(), options, (message.instructionType as any).addSaliencyCandidateFromNode)
                    };
                    break;
                case /* Yarn.Instruction.SelectSaliencyCandidateInstruction selectSaliencyCandidate */ 23:
                    message.instructionType = {
                        oneofKind: "selectSaliencyCandidate",
                        selectSaliencyCandidate: Instruction_SelectSaliencyCandidateInstruction.internalBinaryRead(reader, reader.uint32(), options, (message.instructionType as any).selectSaliencyCandidate)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: Instruction, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.instructionType.oneofKind === "addSaliencyCandidate")
            Instruction_AddSaliencyCandidateInstruction.internalBinaryWrite(message.instructionType.addSaliencyCandidate, writer.tag(21, WireType.LengthDelimited).fork(), options).join();
        /* Yarn.Instruction.AddSaliencyCandidateFromNodeInstruction addSaliencyCandidateFromNode = 22; */
        if (message.instructionType.oneofKind === "addSaliencyCandidateFromNode")
            Instruction_AddSaliencyCandidateFromNodeInstruction.internalBinaryWrite(message.instructionType.addSaliencyCandidateFromNode, writer.tag(22, WireType.LengthDelimited).fork(), options).join();
        /* Yarn.Instruction.SelectSaliencyCandidateInstruction selectSaliencyCandidate = 23; */
        if (message.instructionType.oneofKind === "selectSaliencyCandidate")
            Instruction_SelectSaliencyCandidateInstruction.internalBinaryWrite(message.instructionType.selectSaliencyCandidate, writer.tag(23, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class Instruction_AddSaliencyCandidateInstruction$Type extends MessageType<Instruction_AddSaliencyCandidateInstruction> {
    constructor() {
        super("Yarn.Instruction.AddSaliencyCandidateInstruction", [
            { no: 1, name: "contentID", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "complexityScore", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 3, name: "destination", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value?: PartialMessage<Instruction_AddSaliencyCandidateInstruction>): Instruction_AddSaliencyCandidateInstruction {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.contentID = "";
        message.complexityScore = 0;
        message.destination = 0;
        if (value !== undefined)
            reflectionMergePartial<Instruction_AddSaliencyCandidateInstruction>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Instruction_AddSaliencyCandidateInstruction): Instruction_AddSaliencyCandidateInstruction {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string contentID */ 1:
                    message.contentID = reader.string();
                    break;
                case /* int32 complexityScore */ 2:
                    message.complexityScore = reader.int32();
                    break;
                case /* int32 destination */ 3:
                    message.destination = reader.int32();
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: Instruction_AddSaliencyCandidateInstruction, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string contentID = 1; */
        if (message.contentID !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.contentID);
        /* int32 complexityScore = 2; */
        if (message.complexityScore !== 0)
            writer.tag(2, WireType.Varint).int32(message.complexityScore);
        /* int32 destination = 3; */
        if (message.destination !== 0)
            writer.tag(3, WireType.Varint).int32(message.destination);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message Yarn.Instruction.AddSaliencyCandidateInstruction
 */
export const Instruction_AddSaliencyCandidateInstruction = new Instruction_AddSaliencyCandidateInstruction$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Instruction_AddSaliencyCandidateFromNodeInstruction$Type extends MessageType<Instruction_AddSaliencyCandidateFromNodeInstruction> {
    constructor() {
        super("Yarn.Instruction.AddSaliencyCandidateFromNodeInstruction", [
            { no: 1, name: "nodeName", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "destination", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value?: PartialMessage<Instruction_AddSaliencyCandidateFromNodeInstruction>): Instruction_AddSaliencyCandidateFromNodeInstruction {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.nodeName = "";
        message.destination = 0;
        if (value !== undefined)
            reflectionMergePartial<Instruction_AddSaliencyCandidateFromNodeInstruction>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Instruction_AddSaliencyCandidateFromNodeInstruction): Instruction_AddSaliencyCandidateFromNodeInstruction {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: Instruction_AddSaliencyCandidateFromNodeInstruction, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string nodeName = 1; */
        if (message.nodeName !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.nodeName);
        /* int32 destination = 2; */
...
/**
 * @generated MessageType for protobuf message Yarn.Instruction.AddSaliencyCandidateFromNodeInstruction
 */
export const Instruction_AddSaliencyCandidateFromNodeInstruction = new Instruction_AddSaliencyCandidateFromNodeInstruction$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Instruction_SelectSaliencyCandidateInstruction$Type extends MessageType<Instruction_SelectSaliencyCandidateInstruction> {
    constructor() {
        super("Yarn.Instruction.SelectSaliencyCandidateInstruction", []);
    }
    create(value?: PartialMessage<Instruction_SelectSaliencyCandidateInstruction>): Instruction_SelectSaliencyCandidateInstruction {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<Instruction_SelectSaliencyCandidateInstruction>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Instruction_SelectSaliencyCandidateInstruction): Instruction_SelectSaliencyCandidateInstruction {
        return target ?? this.create();
    }
    internalBinaryWrite(message: Instruction_SelectSaliencyCandidateInstruction, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message Yarn.Instruction.SelectSaliencyCandidateInstruction
 */
export const Instruction_SelectSaliencyCandidateInstruction = new Instruction_SelectSaliencyCandidateInstruction$Type();
// @generated message type with reflection information, may provide speed optimized methods
